...
function test (opts, vals) {
  ...
  for(let i = 0; i < opts.length; i++) {
    ...
    switch(action) {
      case 'enqueue' :
        console.log('enqueue', queue[action](vals[i]))
        break;
      case 'dequeue':
        console.log('dequeue', queue[action]());
        break;
      case 'front':
        console.log('front',queue[action]());
        break;
      case 'size':
        console.log('size', queue[action]());
        break;
      case 'empty':
        console.log('empty', queue[action]());
        break;
      case 'full':
        console.log('full', queue[action]());
        break;
    }
  }
}
